...
function Chat() {
    ...
    return (
        <div className = 'fixed z-50 bottom-10 left-10'>
            ...
            <button onClick={() => {
                    toggleBot((prev) => !prev)
                }} className = "flex flex-wrap items-center justify-center py-1 font-medium no-underline duration-500 rounded-full w-14 h-14 text-neutral-900 bg-cream-300 hover:text-white hover:border-solid hover:border-slate-50 hover:bg-cream-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" /*class="appChatbotButtonIcon_Lq7z"*/ className="rounded-full w-9 h-9">
